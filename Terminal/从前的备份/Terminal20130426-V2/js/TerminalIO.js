...
var CommandSet = [
    ...
    {"name": "show", "cmd": "Show_iframe()",
        "helpdes":"显示iframe"},
    {"name": "sch", "cmd": "SearchInWeb(cmdstr)"
        ,"helpdes":"在网页中搜索字符。"},
    {"name": "search", "cmd": "SearchInWeb(cmdstr)"
        ,"helpdes":"在网页中搜索字符。"},
    {"name": "link", "cmd": "DirectToLocation(cmdstr)"
        ,"helpdes":"打开某个网址。"},
    {"name": "eval", "cmd": "EvalMode().Process(cmdstr, 'I')"
        ,"helpdes":"打开JavaScript调试模式。"}
];
...
function Output(text) {
    var parent_id = IO_Config.parent_id;
    var css_style_name = IO_Config.style.Output;
...
var Command = function (parent_id) {
    ...
    function About() {
        ...
        description += "版本号：2<br />";
        description += "更新时间：2013-4-19<br />";
...
function AddTerminalEventListener(){
    $("#"+IO_Config.parent_id).bind("mousemove",function(){
